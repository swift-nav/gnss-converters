...
static void make_1002_single_gps(void) {
  ...
  msg.sats[0].obs[L1_FREQ].flags.valid_pr = true;
  msg.sats[0].obs[L1_FREQ].flags.valid_cp = true;
  msg.sats[0].obs[L1_FREQ].flags.valid_lock = true;
  msg.sats[0].obs[L1_FREQ].flags.valid_cnr = true;
...
static void make_1002_multi_gps(void) {
  ...
  msg.sats[0].obs[L2_FREQ].flags.valid_lock = true;
  msg.sats[0].obs[L2_FREQ].flags.valid_pr = true;
  msg.sats[0].obs[L2_FREQ].flags.valid_cp = true;
  msg.sats[0].obs[L2_FREQ].flags.valid_cnr = true;
  add_obs_to_output(&msg, rtcm3_encode_1002);
...
static rtcm_msg_eph make_gps_eph(void) {
  ...
  msg.kepler.cis = 65;
  msg.kepler.dn = 13228;
  msg.kepler.m0 = 590289140;
  msg.kepler.ecc = 44660822;
  msg.kepler.sqrta = 2702028478;
  msg.kepler.omega0 = -20899457;
  msg.kepler.omegadot = -22352;
  msg.kepler.w = -1906571568;
  msg.kepler.inc = 640744167;
  msg.kepler.inc_dot = -1204;
  msg.kepler.af0 = -914028;
  msg.kepler.af1 = -44;
  msg.kepler.af2 = 0;
  msg.kepler.toc = 26099;
  msg.kepler.iodc = 6;
  msg.kepler.iode = 6;
  msg.kepler.codeL2 = 1;
  msg.kepler.L2_data_bit = 1;
  return msg;
}
...
rtcm_msm_message make_gps_msm(void) {
  ...
  msg.signals[0].flags.valid_pr = 1;
  msg.signals[0].flags.valid_cp = 1;
  msg.signals[0].flags.valid_cnr = 1;
  msg.signals[0].flags.valid_lock = 1;
  msg.signals[0].flags.valid_dop = 1;
...
rtcm_msm_message make_glo_msm(void) {
  ...
  msg.signals[1].flags.valid_pr = 1;
  msg.signals[1].flags.valid_cp = 0;
  msg.signals[1].flags.valid_cnr = 1;
  msg.signals[1].flags.valid_lock = 1;
  msg.signals[1].flags.valid_dop = 1;
...
rtcm_msm_message make_gal_msm(void) {
  ...
  msg.signals[1].flags.valid_pr = 1;
  msg.signals[1].flags.valid_cp = 1;
  msg.signals[1].flags.valid_cnr = 1;
  msg.signals[1].flags.valid_lock = 1;
  msg.signals[1].flags.valid_dop = 1;
  ...
  msg.signals[2].flags.valid_pr = 1;
  msg.signals[2].flags.valid_cp = 1;
  msg.signals[2].flags.valid_cnr = 1;
  msg.signals[2].flags.valid_lock = 1;
  msg.signals[2].flags.valid_dop = 1;
